...
const CustomDialog = React.forwardRef(({ closeModal, isOpen, id }, ref) => {
          ...
          >
            <Dialog.Panel className="flex flex-col w-full max-w-md gap-4 p-6 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
              ...
              <Dialog.Description className="text-sm text-gray-500">
                To claim the commission as counterparty, please enter the secret
                key obtained from the owner.
              </Dialog.Description>
